...
ActiveRecord::Schema.define(version: 20150122072350078) do
  ...
  create_table "archived_items", force: :cascade do |t|
  ...
  add_index "books", ["publication_id"], name: "index_books_on_publication_id", using: :btree
  ...
  add_index "fines", ["book_movement_id"], name: "index_fines_on_book_movement_id", using: :btree
  add_index "fines", ["student_id"], name: "index_fines_on_student_id", using: :btree
  ...
  create_table "student_answer_sheets", force: :cascade do |t|
    ...
    t.integer  "question_databases_id", limit: 4
  ...
  add_index "user_employees", ["employee_id"], name: "index_user_employees_on_employee_id", using: :btree
  add_index "user_employees", ["user_id"], name: "index_user_employees_on_user_id", using: :btree
  ...
  add_index "user_students", ["student_id"], name: "index_user_students_on_student_id", using: :btree
  add_index "user_students", ["user_id"], name: "index_user_students_on_user_id", using: :btree
  ...
  create_table "weightages", force: :cascade do |t|
    ...
    t.integer  "placement_exam_id", limit: 4
    t.integer  "question_type_id",  limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  end
